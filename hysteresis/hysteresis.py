...
def calc(K):
    ...
    epsilon = 1e-6   # small perturbation to escape meta-stable point
    epsilon = 0
    ...
    plt.savefig(f"hystloop-theta={theta_degree}-K={K}-epsilon={epsilon}.png")
    plt.show()
    plt.close()
...
if __name__ == '__main__':
    ...
    Ks = [1e4, 1e5, 1e6]  # vary the anisotropy constant
